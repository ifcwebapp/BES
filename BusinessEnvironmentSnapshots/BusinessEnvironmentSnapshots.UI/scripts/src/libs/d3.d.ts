...
declare module D3 {
    ...
    interface Selectors {
        ...
        */
        selectAll(elements: EventTarget[]): Selection;
    }
    ...
    export interface Selection extends Selectors, Array<any> {
        ...
        attr(name: string, valueFunction: (data: any, index: number) => any): Selection;
        attr(values: { [key: string]: any }): Selection;

        classed(name: string): boolean;
        classed(name: string, value: any): Selection;
        classed(name: string, valueFunction: (data: any, index: number) => any): Selection;
        classed(classValueMap: Object): Selection;

        style(name: string): string;
        style(name: string, value: any, priority?: string): Selection;
        style(name: string, valueFunction: (data: any, index: number) => any, priority?: string): Selection;
        style(styleValueMap: Object): Selection;
         ...
         */
        datum<a>(values: (data: a, index: number) => any): TypedSelection<a>;
        /**
         ...
         */
        datum<a>(values: a[]): TypedSelection<a>;
        /**
        ...
        on(type: string): (data: any, index: number) => any;
        on(type: string, listener: (data: any, index: number) => any, capture?: boolean): Selection;
    ...
    export module Svg {
        ...
        export interface Axis {
            ...
            tickSubdivide(yesOrNo: boolean): Axis;
        ...
        export interface Line<a> {
            ...
            * @param index Optional index
            */
            (data: a[], index?: number): string;
            /**
            * Get the x-coordinate accessor.
            */
            x(): (data: a, index?: number) => number;
            /**
            * Set the x-coordinate accessor.
            *
            * @param accessor The new accessor function
            */
            x(accessor: (data: any) => number): Line<a>;
            x(accessor: (data: any, index: number) => number): Line<a>;
            /**
            ...
            */
            y(): (data: a, index?: number) => number;
            /**
            * Set the y-coordinate accessor.
            *
            * @param accessor The new accessor function
            */
            y(accessor: (data: a) => number): Line<a>;
            y(accessor: (data: a, index: number) => number): Line<a>;
            /**
            ...
            */
            interpolate(interpolate: string): Line<a>;
            /**
    ...
    export module Scale {
        ...
        export interface GenericScale<S> {
            ...
            domain(values: [Date, Date]): S;
            domain(values: [number, number]): S;
            domain<a>(values: a[]): S;
            domain(): any[];
            range: {
                (values: any[]): S;
