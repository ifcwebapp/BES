...
namespace BusinessEnvironmentSnapshots.Database.ChartRepository
{
    ...
    {
        private SingleChart GetRegulatoryQualityChart(string id, string countryCode, string yearConfig)
        {
            ...
            if (chartInfo != null)
            {
                ...
                //    SeriesType.Bar,
                //    countries.ToDictionary(k => k.Key, k => k.Value.Name), g => g.Year, d => new ErrorPoint { Value = d, Error = null },
                //    out cats, out sers);
